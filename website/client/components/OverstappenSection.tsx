  ...
  return (
    <section ref={sectionRef} className="w-full pt-0 pb-[25px] relative z-20 fade-in-section scroll-mt-[80px]" data-section="overstappen">
      <div className="px-4 sm:px-6 lg:px-[60px]">
        ...
        {/* Overstap agent card */}
        <div className="w-full max-w-[500px] border border-dashed border-fp-gray-border rounded-[5px] pt-5 pb-5 px-5">
          ...
          {/* Green box */}
          <div className="border border-black rounded-[5px] bg-fp-gray-btn px-4 py-4 mb-4">
